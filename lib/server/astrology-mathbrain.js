...
const { calculateRelocatedHouses } = require('../relocation-houses');
        
        try {
          // Internal relocation calculation
          const relocatedHouses = calculateRelocatedHouses(
            personA,
            relocatedCoords.latitude,
            relocatedCoords.longitude,
            pass.houses_system_identifier || 'placidus'
          );

          // Create a relocated chart object
          const personARelocated = {
            ...personANatal,
            chart: {
              ...personANatal.chart,
              house_cusps: relocatedHouses.houses,
              angles: {
                ...personANatal.chart.angles,
                Ascendant: { abs_pos: relocatedHouses.asc },
                Midheaven: { abs_pos: relocatedHouses.mc },
              }
            }
          };
          ...
          logger.info('[TRANSLOCATION] Successfully calculated Felt Weather chart', {
          ...
          logger.error('[TRANSLOCATION] Failed to calculate relocated chart, falling back to natal:', error.message);
