 ...
 * Format: [name(s)]_[dates]_[type].json for easier file browsing
 * @param {string} type The export type
...
function getExportFilename(
  ...
  // Name and date first for easier file browsing, type suffix last
  return `${duo}_${dateStr}_${prefix}.${extension}`;
}
