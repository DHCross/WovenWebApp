...
function classifySfd(value) { // DEPRECATED: SFD metric retired
  throw new Error('SFD classification has been retired. Use directional bias and magnitude instead.');
}
...
function validateSfdOrbIntegrity(supportiveAspects, profileName = 'STANDARD') {
  throw new Error('SFD (Support-Friction Differential) has been retired. Use directional bias and magnitude metrics instead.');
}
