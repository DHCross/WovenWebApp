        ...
        <div className="mb-6 rounded border border-slate-700 bg-slate-900/50 p-4">
          <div className="flex justify-center">
            <button
              ...
              className="group relative cursor-zoom-in focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-slate-900 rounded-lg"
            ...
            >
              <img
                ...
                className="w-full max-w-md md:max-w-lg lg:max-w-xl h-auto rounded-lg transition-transform group-hover:scale-[1.02]"
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/0 group-hover:bg-black/20 transition-colors rounded-lg">
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-white text-sm bg-black/60 px-3 py-1.5 rounded-full flex items-center gap-1.5">
      ...
      {isLightboxOpen && wheelChart?.url && (
        ...
        >
          <div className="relative max-w-[95vw] max-h-[95vh] p-4">
            ...
            <button
              onClick={() => setIsLightboxOpen(false)}
              className="absolute -top-2 -right-2 z-10 rounded-full bg-slate-800 border border-slate-600 p-2 text-white hover:bg-slate-700 transition-colors shadow-lg"
              title="Close (Esc)"
            >
            ...
            <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 flex items-center gap-4">
              <button
                ...
                disabled={isDownloading}
                className="inline-flex items-center gap-2 rounded-full bg-purple-600 px-4 py-2 text-sm font-medium text-white hover:bg-purple-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-lg"
              >
                {isDownloading ? (
                  <>
                    <svg className="animate-spin h-4 w-4" viewBox="0 0 24 24">
              ...
              <span className="text-slate-400 text-sm">Press Esc or click outside to close</span>
            </div>
          </div>
        </div>
      )}
